...
function applyAuthState() {
  ...
  const myCharsLink   = document.querySelector('.nav-links a[data-page="mychars"]');
  const campaignsLink = document.querySelector('.nav-links a[data-page="campaigns"]');
  if (myCharsLink)   myCharsLink.parentElement.style.display   = loggedIn ? '' : 'none';
  if (campaignsLink) campaignsLink.parentElement.style.display = loggedIn ? '' : 'none';
